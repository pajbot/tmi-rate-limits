...
See for example (my implementation): https://github.com/robotty/dank-twitch-irc/blob/master/lib/client/ratelimiters/privmsg.ts
...
#### `privmsg-moderator-bucket`
  ...
  - Refill Amount:
      ...
      - If your account has the `known` status: 100
